...
function Contact() {
  ...
  const form = useRef();
  const submit = (data) => {
    // email js library functionsetIsLoading(true);
    setIsLoading(true);
    console.log(data);
    setIsMailed(false);
    emailjs
            ...
            <div className=" contacts col-12 col-md-5 offset-md-1 ps-5 ">
              <div className=" mt-5 ">
                <h3 className="  text-white address">
                  <FaAddressBook className=" aboutLin me-3" />
                  Address
                </h3>
                <h5 className=" ps-2 text-white">Myingyan , Semekhon</h5>
              </div>
              <div className=" mt-5 ">
                <h3 className="  text-white address">
                  <FaPhoneAlt className=" aboutLin me-3" />
                  Phone
                </h3>
                <h5 className=" ps-2 text-white">09796788834</h5>
              </div>
              <div className=" mt-5 ">
                <h3 className="  text-white address">
                  <FaMailBulk className=" aboutLin me-3" />
                  Email
                </h3>
                <h5 className=" ps-2 text-white">kaungkhants892@gmail.com</h5>
              </div>
            </div>
            <div className=" col-md-5 col-12  ps-5 mt-4 ">
              ...
              <div className=" ">
                ...
                >
                  ...
                  <button className=" postBtn btn  px-4 mt-3 " type="submit">
